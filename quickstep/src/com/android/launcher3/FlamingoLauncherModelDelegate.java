...
public class FlamingoLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "FlamingoLauncherModelDelegate";
    ...
    public FlamingoLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
