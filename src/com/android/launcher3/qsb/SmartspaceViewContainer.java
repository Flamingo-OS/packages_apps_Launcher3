...
import com.android.launcher3.FlamingoLauncher;
import com.android.launcher3.FlamingoLauncherModelDelegate;
...
public class SmartspaceViewContainer extends FrameLayout implements PluginListener<BcSmartspaceDataPlugin> {
    ...
    public SmartspaceViewContainer(Context context, AttributeSet attributeSet) {
        ...
        FlamingoLauncher launcher = (FlamingoLauncher) ActivityContext.lookupContext(context);
        launcher.getLauncherUnlockAnimationController().setSmartspaceView(mView);

        FlamingoLauncherModelDelegate delegate = (FlamingoLauncherModelDelegate) launcher.getModel().getModelDelegate();
    ...
    public void onPluginDisconnected(BcSmartspaceDataPlugin plugin) {
        FlamingoLauncher launcher = (FlamingoLauncher) ActivityContext.lookupContext(getContext());
